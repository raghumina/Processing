...
# Dragster game assignment 
# 

# Reach the endof the screen in the given time 

# Use "A" or "a" to accelerate the car and "G" or "g" to increase the speed of the car 
...
def drawMenu():
    ...
    textAlign(CENTER)
    textSize(64)
    text("Dragster",width/2,height/3)
...
def drawCountdown():
    global StartTime, countdownTime, stoppedTime, usedTime, pms
  #  countdown = 5
...
def drawPlayState():
    global carSpeed, carX1, CurrentState, offsetTime, StartTime
...
def keyPressed():
    global CurrentState, StartTime, countdownTime 
